...
namespace XAnimation
{
        ...
        public override Animation CreateAnimation(VisualElement element)
        {
            ...
            if (Math.Abs(DistanceY) > 0.001)
            {
                ...
                animation.WithConcurrent(
                    ...
                    element.TranslationY + DistanceY / 2,
                    Easings.CubicInOut,
                    0.5,
                    0.6);
            ...
            if (Math.Abs(DistanceX) > 0.001)
            {
                ...
                animation.WithConcurrent(
                    ...
                    element.TranslationX + DistanceX / 2,
                    Easings.CubicInOut,
                    0.5,
                    0.6);
    ...
    public class WobbleAnimation : AnimationDefinition
    {
        ...
        public override Animation CreateAnimation(VisualElement element)
        {
            ...
            animation.WithConcurrent(
                f => element.TranslationX = f,
                element.TranslationX + Distance * 0.8,
                element.TranslationX - Distance * 0.6,
                null,
                0.45,
                0.6);
            animation.WithConcurrent(
                f => element.TranslationX = f,
                element.TranslationX - Distance * 0.6,
                element.TranslationX + Distance * 0.4,
                null,
                0.6,
                0.75);
            animation.WithConcurrent(
                f => element.TranslationX = f,
                element.TranslationX + Distance * 0.4,
                element.TranslationX - Distance * 0.2,
                null,
                0.75,
                1.0);
    ...
    public class JumpAnimation : AnimationDefinition
    {
        ...
        public override Animation CreateAnimation(VisualElement element)
        {
            ...
            animation.WithConcurrent(
                f => element.TranslationY = f,
                element.TranslationY + Distance,
                element.TranslationY + Distance * 0.5,
                null,
                0.6,
                0.8);
            animation.WithConcurrent(
