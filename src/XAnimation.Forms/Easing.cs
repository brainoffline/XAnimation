...
namespace XAnimation
{
    ...
    internal class QuadraticEasing
    {
        ...
        public static Easing InOut = new Easing(
            x =>
            {
    ...
    {
        public static Easing In = new Easing(
            x =>
            {
        ...
        public static Easing Out = new Easing(
            x =>
            {
                if (x.EqualsZero()) return 0;
                if (x.EqualsOne()) return 1;
    ...
    {
        public static Easing In  = new Easing(x => x.EqualsZero() ? 0 : Math.Pow(1024, x - 1));
        public static Easing Out = new Easing(x => x.EqualsOne() ? 1 : 1 - Math.Pow(2, -10 * x));
    ...
    public class PowerEasing
    {
        ...
        public Func<double, double> In => x => Math.Pow(x, _power);

        public Func<double, double> Out => x => 1 - Math.Pow(--x, _power);
    ...
    {
        public static bool EqualsZero(this double f)
        {
            return Math.Abs(f) < float.Epsilon;
        }

        public static bool EqualsOne(this double f)
        {
